...
source "$OSH_CUSTOM/themes/powerline-multiline/powerline-multiline.base.sh"
...
PYTHON_VENV_THEME_PROMPT_COLOR=28
...
POWERLINE_LEFT_PROMPT=${POWERLINE_LEFT_PROMPT:="scm python_venv ruby"}
POWERLINE_RIGHT_PROMPT=${POWERLINE_RIGHT_PROMPT:="in_vim battery user_info"}
POWERLINE_BOTTOM_PROMPT=${POWERLINE_BOTTOM_PROMPT:="clock cwd"}
